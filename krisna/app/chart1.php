...
for ($i = 6; $i >= 0; $i--) {
    ...
    if ($conn) {
        $query = mysqli_query($conn, "SELECT COUNT(id) AS jumlah FROM arsip_paspor WHERE status = 'Aktif' AND tanggal_input = '$tgl_loop'");
...
<html>
<head>
    <title>Chart Arsip 7 Hari</title>
